...
def main(
    ...
    input_json_path: str = '/root/lanyun/RDRec/data/toys/explanation_rationale copy.json',
    output_json_path: str = '/root/lanyun/RDRec/data/toys/explanation_two_stage.json', #文件名稍作修改以示区别
